...
[![Version](badges/latest-release.svg)](https://pypi.python.org/pypi/kysy/)
[![Downloads](badges/downloads-per-month.svg)](https://pepy.tech/project/kysy)
[![Python](badges/python-versions.svg)](https://pypi.python.org/pypi/kysy/)
[![Maintenance Status](badges/commits-per-year.svg)](https://git.sr.ht/~sthagen/kysy/log)
